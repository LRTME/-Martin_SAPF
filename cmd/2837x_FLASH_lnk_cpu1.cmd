/****************************************************************
* FILENAME:     2837x_FLASH_lnk.cmd             
* DESCRIPTION:  device linker command file 
* AUTHOR:       Mitja Nemec
* NOTES:        based upon DSP28377D CPU1 Header Files
*
****************************************************************/
...
PAGE 1 :
    ...
    /* Flash sectors */
    D_FA        : origin = 0x080002,    length = 0x001FFE       /* on-chip Flash */
    D_FB        : origin = 0x082000,    length = 0x002000       /* on-chip Flash */
    D_FC        : origin = 0x084000,    length = 0x002000       /* on-chip Flash */
    D_FD        : origin = 0x086000,    length = 0x002000       /* on-chip Flash */
    D_FE        : origin = 0x088000,    length = 0x008000       /* on-chip Flash */
    D_FF        : origin = 0x090000,    length = 0x008000       /* on-chip Flash */
    D_FG        : origin = 0x098000,    length = 0x008000       /* on-chip Flash */
    D_FH        : origin = 0x0A0000,    length = 0x008000       /* on-chip Flash */
    D_FI        : origin = 0x0A8000,    length = 0x008000       /* on-chip Flash */
    D_FJ        : origin = 0x0B0000,    length = 0x008000       /* on-chip Flash */
    D_FK        : origin = 0x0B8000,    length = 0x002000       /* on-chip Flash */
    D_FL        : origin = 0x0BA000,    length = 0x002000       /* on-chip Flash */
    D_FM        : origin = 0x0BC000,    length = 0x002000       /* on-chip Flash */
    D_FN        : origin = 0x0BE000,    length = 0x002000       /* on-chip Flash */   
