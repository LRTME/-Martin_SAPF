...
{
    // PREDIKCIJA
	v->u_cap_estimated = v->u_cap_estimated_1 + v->i_cap_estimated_1 * ABF_SAMPLE_TIME / v->Capacitance;
	...
	v->i_cap_estimated = v->i_cap_estimated + v->Beta * v->err_ucap * v->Capacitance * ABF_SAMPLE_FREQ;
